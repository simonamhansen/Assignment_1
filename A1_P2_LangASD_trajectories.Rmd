...
According to the mixed effect analysis there is a positive relationship between the number of visits and the MLU of the child, b= 0.23, t(60.78) = 9.52, p < .05. However the model displays  no significant influence of the diagnosis on the MLU of the child, b=0.29, (60.08) = 1.91, p > 0.5
...
According to the model there is a positive relationship of the number of visits on the MLU of the parents, b = 0.12, t(59.53) = 6.60, p < .05. 

The model also suggest that the parents of the typically developing children have significantly larger MLU's than those who are parent of autistic children, b= 0.50, t(60.92) = 4.43, p < .05. 
