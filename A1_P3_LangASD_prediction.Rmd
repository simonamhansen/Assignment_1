...
# Visit 1
Bernie_visit1=myfunction(1, 3.414397, 28)
dif_visit1 = 1.984456 - Bernie_visit1   

# Visit 2
Bernie_visit2=myfunction(2, 5.125000 ,28)
dif_visit2 = 2.544444 - Bernie_visit2

# Visit 3
Bernie_visit3=myfunction(3, 4.368557 ,28)
dif_visit3 = 3.353191 - Bernie_visit3

# Visit 4
Bernie_visit4=myfunction(4, 4.516529 ,28)
dif_visit4 = 3.183099 - Bernie_visit4

# Visit 5
Bernie_visit5=myfunction(5, 4.019565 ,28)
dif_visit5 = 3.173252 - Bernie_visit5

# Visit 6
Bernie_visit6=myfunction(6, 3.818557 ,28)
dif_visit6 = 3.448413 - Bernie_visit6

# To create a dataframe 
Visits = c(1,2,3,4,5,6)
Category = c("TD", "TD","TD","TD","TD","TD", "Bernie","Bernie","Bernie","Bernie","Bernie","Bernie")
MLU = c(Bernie_visit1, Bernie_visit2, Bernie_visit3, Bernie_visit4, Bernie_visit5, Bernie_visit6, Bernie_data$CHI_MLU)
...
Comparing Bernie to typically developing children with the same Verbal IQ and Mother MLU we see that he is actually above average on all visists (except visit 2). Therefor it seem like there is no need to introduce an intervention.
