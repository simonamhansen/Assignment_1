...
for (fold in folds){
  ...
  # To train model
  m3 = lmerTest::lmer(CHI_MLU ~ 1 + VISIT + MOT_MLU + verbalIQ + (1 + VISIT|ID), train_data, REML = FALSE)
...
Bernie_comp=data.frame(c(Bernie_visit1, Bernie_visit2, Bernie_visit3, Bernie_visit4, Bernie_visit5, Bernie_visit6), c(dif_visit1, dif_visit2, dif_visit3, dif_visit4, dif_visit5, dif_visit6))
